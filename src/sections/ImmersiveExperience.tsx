...
const stats = [
  { icon: "eco", label: "Ethically Sourced", sub: "Directly from the farm to our roastery." },
  { icon: "local_fire_department", label: "Artisan Roasted", sub: "Small batches for maximum flavor profile." },
  { icon: "history_edu", label: "Heritage Brewed", sub: "Combining old-world techniques with new technology." },
];
    ...
    <section className="relative min-h-[560px] md:h-[819px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl px-6 md:px-5 py-16 md:py-0">
        ...
        <p className="text-sm md:text-lg text-[#D9C1AA] mb-10 md:mb-10 leading-relaxed max-w-xl mx-auto">
          More than just a drink, it&apos;s a sensory journey. We source the finest beans, roast with care, and craft each cup to deliver a rich and unforgettable experience.
        </p>
