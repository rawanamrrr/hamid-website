        ...
        <div className="flex flex-col gap-4 md:hidden">
          <div className="group relative overflow-hidden rounded-3xl luxury-shadow bg-[#0D0705] h-52">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
              <h3 className="font-[family-name:var(--font-plus-jakarta)] text-xl font-bold mb-1">Coffee Beans</h3>
              <p className="text-sm opacity-80 mb-3">Explore our world-class origins and signature blends.</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="group relative overflow-hidden rounded-3xl luxury-shadow bg-black h-40">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 text-white">
                <h3 className="font-[family-name:var(--font-plus-jakarta)] text-base font-bold">Turkish Coffee</h3>
              </div>
            </div>
            <div className="group relative overflow-hidden rounded-3xl luxury-shadow bg-[#7b5800] h-40">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 text-white">
                <h3 className="font-[family-name:var(--font-plus-jakarta)] text-base font-semibold">Espresso</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:grid grid-cols-6 grid-rows-2 gap-6 h-[600px]">
          <div className="col-span-3 row-span-2 group relative overflow-hidden rounded-[1.75rem] luxury-shadow bg-[#0D0705]">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-10 text-white">
              <h3 className="font-[family-name:var(--font-plus-jakarta)] text-2xl font-bold mb-2">Coffee Beans</h3>
              <p className="opacity-80 mb-6">Explore our world-class origins and signature house blends.</p>
          ...
          <div className="col-span-3 row-span-1 group relative overflow-hidden rounded-[1.75rem] luxury-shadow bg-black">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 text-white">
              <h3 className="font-[family-name:var(--font-plus-jakarta)] text-2xl font-bold mb-1">Turkish Coffee</h3>
              <a href="/menu" className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#ffdea6]">
          ...
          <div className="col-span-3 row-span-1 group relative overflow-hidden rounded-[1.75rem] luxury-shadow bg-[#7b5800]">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
              <h3 className="font-[family-name:var(--font-plus-jakarta)] text-2xl font-semibold mb-1">Espresso</h3>
            </div>
          </div>
        </div>
      </div>
