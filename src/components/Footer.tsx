...
const sections = [
  {
    title: "Experience",
    links: ["Sourcing", "Brewing Guides", "Wholesale", "Careers"],
  },
  {
    title: "Customer Care",
    links: ["Contact Us", "Shipping & Returns", "Store Locator", "FAQ"],
  },
];
  ...
  return (
    <div className="border-b border-white/10 md:border-none">
      ...
      >
        ...
        <span className="material-symbols-outlined text-[#7b5800] text-lg md:hidden">
      ...
      <ul className={`space-y-3 overflow-hidden transition-all duration-300 ${open ? "max-h-60 pb-4" : "max-h-0 md:max-h-none"} md:max-h-none md:pb-0 md:mt-6`}>
        {links.map((item) => (
          <li key={item}>
            <a href="#" className="text-[#D9C1AA] hover:text-[#7b5800] transition-all text-sm md:text-base block py-0.5">
              {item}
            </a>
          </li>
        ))}
      ...
      <div className="px-5 md:px-16 py-12 md:py-20 max-w-[1280px] mx-auto text-white">
            ...
            <div className="md:hidden space-y-4">
              <Link href="/">
                <Image
                  ...
                  width={120}
                  height={40}
                  className="object-contain brightness-[0.85] sepia saturate-[3] hue-rotate-[5deg]"
                />
              </Link>
              <p className="text-[#D9C1AA] text-sm opacity-80 max-w-xs">
                Bringing people together through the rich tradition of Egyptian coffee. From our roastery in Taksem Khattab to your cup.
              </p>
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:border-[#7b5800] hover:text-[#7b5800] transition-all">
        ...
        <div className="hidden md:grid grid-cols-4 gap-6">
          <div className="space-y-6">
            <Link href="/">
              <Image src="/hamid-logo.png" alt="Hamid Afandi" width={140} height={48} className="object-contain brightness-[0.85] sepia saturate-[3] hue-rotate-[5deg]" />
            </Link>
            <p className="text-[#D9C1AA] text-base opacity-80">
              Bringing people together through the rich tradition of Egyptian coffee. From our roastery in Taksem Khattab to your cup.
            </p>
          ...
          {sections.map(({ title, links }) => (
            <div key={title}>
              ...
              <ul className="space-y-4">
                {links.map((item) => (
                  <li key={item}><a href="#" className="text-[#D9C1AA] hover:text-[#7b5800] transition-all text-base">{item}</a></li>
                ))}
              </ul>
            </div>
          ))}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-[#7b5800] mb-6">Our Branch</h4>
            <p className="text-[#D9C1AA] text-base opacity-80 mb-4">
              Visit us at Taksem Khattab, Mansoura for a premium coffee experience.
            </p>
        ...
        <div className="md:hidden border-t border-white/10 mt-2">
          ...
          <div className="border-b border-white/10 py-4">
            <h4 className="text-xs font-semibold uppercase tracking-widest text-[#7b5800] mb-2">Our Branch</h4>
            <p className="text-[#D9C1AA] text-sm opacity-80">Taksem Khattab, Mansoura — Open Daily</p>
          </div>
        </div>
      </div>

      <div className="border-t border-white/5 py-6 text-center px-5">
        <p className="text-[#D9C1AA] text-xs opacity-60">
          © 2024 Hamid Afandi Coffee. All Rights Reserved.
          <span className="mx-2">|</span>
          <a href="#" className="hover:text-[#7b5800]">Privacy Policy</a>
        </p>
      </div>
    </footer>
  );
