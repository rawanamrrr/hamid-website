...
export default function Footer({ dict }: { dict: Dictionary }) {
  const sections = [
    { title: dict.footer.experienceTitle, links: dict.footer.experienceLinks },
    { title: dict.footer.careTitle, links: dict.footer.careLinks },
  ];
    ...
    <footer className="bg-[#0D0705] border-t border-white/5">
      ...
      <div className="border-t border-white/5 py-6 text-center px-5">
        <p className="text-[#D9C1AA] text-xs opacity-60">
          ...
          <a href="#" className="hover:text-[#7b5800]">{dict.footer.privacyPolicy}</a>
        </p>
      </div>
    </footer>
  );
