    ...
    <section className="py-12 md:py-20 bg-[#ffead8]">
      <div className="px-5 md:px-16 max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col gap-4 md:hidden">
          <Link href={raw1.linkUrl || "#"} className="group relative overflow-hidden rounded-3xl luxury-shadow bg-[#0D0705] h-52 block">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
              ...
              <span className="inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-widest text-[#ffdea6]">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link href={raw3.linkUrl || "#"} className="group relative overflow-hidden rounded-3xl luxury-shadow bg-[#7b5800] h-40 block">
        ...
        <div className="hidden md:grid grid-cols-6 grid-rows-2 gap-6 h-[600px]">
          <Link
            href={raw1.linkUrl || "#"}
            className="col-span-3 row-span-2 group relative overflow-hidden rounded-[1.75rem] luxury-shadow bg-[#0D0705] block"
          >
            <div
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-10 text-white">
              ...
              <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#ffdea6]">
          ...
          <Link
            href={raw3.linkUrl || "#"}
            className="col-span-3 row-span-1 group relative overflow-hidden rounded-[1.75rem] luxury-shadow bg-[#7b5800] block"
          >
            <div
