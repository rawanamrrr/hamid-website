  ...
  return (
    <section className="relative min-h-[480px] md:h-[640px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl px-6 md:px-5 py-12 md:py-0">
        ...
        <p className="text-sm md:text-lg text-[#D9C1AA] mb-8 md:mb-10 leading-relaxed max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-12 text-white">
          {stats.map(({ icon, label, sub }) => (
            ...
            >
              <span aria-hidden="true" className="material-symbols-outlined text-[#7b5800] text-3xl md:text-2xl shrink-0">{icon}</span>
              <div className="md:contents">
                <span className="font-[family-name:var(--font-plus-jakarta)] text-base md:text-2xl font-bold text-[#ffdea6] md:text-[#7b5800] block">
                  {label}
                </span>
