...
import Menu2PageClient from "./Menu2PageClient";
...
export default async function Menu2Page() {
  ...
  if (sections === null) {
    ...
    return <LoadErrorBand message={dict.common.loadError} retryLabel={dict.common.retry} href="/menu2" />;
  }
  return <Menu2PageClient sections={sections} heroImages={heroImages} />;
}
