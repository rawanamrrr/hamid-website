const branches = [
  { name: "Mansoura", address: "Taksem Khattab, Mansoura", active: true },
];
      ...
      <div className="px-5 md:px-16 max-w-[1280px] mx-auto">
        ...
        <div className="md:hidden space-y-5">
          <div className="space-y-1">
            ...
            <p className="text-[#4f4541] text-sm">
              Experience the heritage in person. Visit our branch in the heart of Mansoura.
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl luxury-shadow p-5 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-black text-base">Mansoura Branch</h4>
            ...
            <div className="flex items-center gap-3 text-sm text-[#4f4541]">
              ...
              Open Daily — Morning to Late Evening
            </div>
            <a
        ...
        <div className="hidden md:flex flex-row gap-6 items-center">
          <div className="w-1/3 space-y-10">
            <div className="space-y-3">
              ...
              <p className="text-[#4f4541] text-base">
                Experience the heritage in person. Visit our branch in the heart of Mansoura.
              </p>
            </div>
