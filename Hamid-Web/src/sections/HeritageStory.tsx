        ...
        <div className="relative max-w-xl md:max-w-2xl mx-auto" style={{ minHeight: 440 }}>
          ...
          >
            <h3
              ...
              style={{ color: "#3b1f0a" }}
            >
              From Mansoura to the World
            </h3>
            <p className="text-xs md:text-sm leading-relaxed" style={{ color: "#3b1f0a" }}>
              Since 1920, Hamid Afandi has been a beacon of Egyptian coffee culture. Our journey
              began in the bustling heart of Mansoura, bringing together the finest ethically sourced
              beans with time-honored roasting techniques, crafting a legacy of rich, aromatic blends.
            </p>
            <p className="text-xs md:text-sm leading-relaxed" style={{ color: "#3b1f0a" }}>
              We invite you to experience the tradition.
            </p>
